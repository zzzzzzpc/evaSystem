<template>
	<div>
		...
		<el-table ref="filterTable" :data="bondsAllList" style="width: 100%">
			...
			<el-table-column prop="eva" label="评价值" width="180">
			</el-table-column>
			<el-table-column prop="individual" label="个人评价结果" width="180">
			</el-table-column>
			<el-table-column prop="gradeeva" label="评价值" width="180">
			</el-table-column>
			<el-table-column prop="grade" label="成绩" :formatter="formatter">
			</el-table-column>
			<el-table-column prop="tag" label="标签" width="100" :filters="[{ text: '必修', value: '必修' }, { text: '选修', value: '选修' }]"
			 :filter-method="filterTag" filter-placement="bottom-end">
				<template slot-scope="scope">
					<el-tag :type="scope.row.tag === '必修' ? 'primary' : 'success'" disable-transitions>{{scope.row.tag}}</el-tag>
				</template>
			</el-table-column>
		</el-table>
		<p></p>
